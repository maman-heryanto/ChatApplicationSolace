...
//					    UIManager.setLookAndFeel("com.seaglasslookandfeel.SeaGlassLookAndFeel");
	...
	private void initialize() {
		...
		JLabel lblRouter = new JLabel("Host");
		panel.add(lblRouter, "cell 0 1,alignx trailing");

		txtFldConnectString = new JTextField("tcps://mr-connection-sf4e4quhen2.messaging.solace.cloud:55443");
		...
		txtFldUser.setText("solace-cloud-client");
